...
public struct TurboQuantRuntimeProbeResult: Equatable, Codable, Sendable {
    public static let throughputOptimizedOnlineFusedHeadDimensions = [
        64, 80, 96, 112, 128, 192, 240, 256,
    ]
    public static let throughputOptimizedOnlineFusedMaxQueryLength = 64
...
public func turboQuantMetalSupportsOnlineFusedAttention(
    ...
    guard queryShape[0] == keyLayout.batchSize,
        queryShape[2] <= TurboQuantRuntimeProbeResult.throughputOptimizedOnlineFusedMaxQueryLength
    else { return false }
