    ...
    if Context.environment["SPM_CUDA"] != "0" {
        ...
        platformExcludes =
            [
                ...
                "mlx/mlx/backend/cuda/quantized/qmm/qmm_utils.h",
                "mlx/mlx/backend/cuda/quantized/qmm/qmm_naive.cu",
                "mlx/mlx/backend/cuda/quantized/qmm/qmm_sm80.cu",
                "mlx/mlx/backend/cuda/quantized/qmm/qmm_sm90.cu",
